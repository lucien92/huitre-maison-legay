			...
			<div class="flex-wrapper second">
				<h1 class="title">
					<div class="title-mask">
						<div class="word" bind:this={titleWord1} style="text-transform: capitalize;">Maison</div>
					</div><br> 
					<div class="title-mask">
						<div class="word" bind:this={titleWord2} style="text-transform: capitalize;">Legay</div>
					</div>
				</h1>
				
				<div class="occupation mask">
					<p class = "paragraph" bind:this={shortDetails}>
						<strong>Maison Legay vous accueille à partir des vacances de Pâques </strong>
						<strong>jusqu'à la Toussaint pour déguster des produits de qualité dans un cadre magique.</strong>
					</p>
				</div>
