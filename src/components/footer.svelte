    ...
    <div class="flex-wrapper">
        ...
        <div class="status-wrapper">
            ...
            <p class="large-text" bind:this={statusElem}>
                Vous pouvez aussi me contacter sur mon téléphone: <br><br> 0642877507
            </p>
            <a class="button large-text" bind:this={fullEmailLinkElem} href="stephanie.boulenger@gmail.com" target="_blank">0642877507</a>
        </div>
